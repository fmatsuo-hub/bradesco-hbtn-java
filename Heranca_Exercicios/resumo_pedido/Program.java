...
public class Program {
    public static void main(String[] args) {
            ...
            produtos.Livro livro1 = new produtos.Livro("Duna", 2017, "Brasil", 64.74, 680, "Frank Herbert", 1);
            produtos.Livro livro2 = new produtos.Livro("Um de nos esta mentindo", 2018, "Brasil", 40.17, 384, "Karen Mcmanus", 1);
            produtos.Livro livro3 = new produtos.Livro("Mindset Milionario", 2021, "Brasil", 36.46, 272, "José Roberto Marques", 1);

            produtos.Dvd dvd1 = new produtos.Dvd("Anjos da Noite 5 - Guerras de Sangue", 2016, "Estados Unidos", 20.28, "Anna Foerster", "Ação", 91);
            produtos.Dvd dvd2 = new produtos.Dvd("Annabelle 2 - A Criacao do Mal", 2017, "Brasil", 47.88, "Jame Wan e Peter Safran", "Terror", 109);
